...
ZSH_THEME_GIT_PROMPT_PREFIX="%{$bg[cyan]%} %{$fg[white]%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%{$reset_color%}"
ZSH_THEME_GIT_PROMPT_DIRTY=" %{$bg[default]%} %{$fg[yellow]%}😱%{$reset_color%} "
ZSH_THEME_GIT_PROMPT_CLEAN=" %{$bg[default]%} %{$fg[green]%}😎%{$reset_color%} "
